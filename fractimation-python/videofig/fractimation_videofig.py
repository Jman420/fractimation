...
renderer = multibrot_videofig.multibrot_videofig(width, height, realNumberMin, realNumberMax, imaginaryNumberMin, imaginaryNumberMax,
...
power = 2
escapeValue = 10.0
renderer = multijulia_videofig.multijulia_videofig(width, height, realNumberMin, realNumberMax, imaginaryNumberMin, imaginaryNumberMax,
                                                  constantRealNumber, constantImaginaryNumber, power, escapeValue)
videofig.videofig(maxIterations, renderer.iterate)