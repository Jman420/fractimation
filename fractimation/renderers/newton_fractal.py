...
class NewtonFractal(ComplexPolynomial):
    ...
    def __init__(self, width, height, real_number_min, real_number_max, imaginary_number_min,
        ...
        ComplexPolynomial.__init__(self, width, height, real_number_min, real_number_max,
                                   imaginary_number_min, imaginary_number_max,
                                   initial_real_number, initial_imaginary_number, power,
    ...
    def initialize(self, width, height, real_number_min, real_number_max, imaginary_number_min,
                   imaginary_number_max, initial_real_number, initial_imaginary_number, power,
                   escape_value, color_map='viridis'):
        super().initialize(width, height, real_number_min, real_number_max, imaginary_number_min,
