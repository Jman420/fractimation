...
class Multibrot(CachedImageRenderer, ZoomableComplexRange):
    ...
    def __init__(self, width, height, real_number_min, real_number_max, imaginary_number_min,
        ...
        self.initialize(width, height, real_number_min, real_number_max, imaginary_number_min,
                        imaginary_number_max, initial_real_number, initial_imaginary_number,
    ...
    def initialize(self, width, height, real_number_min, real_number_max, imaginary_number_min,
        ...
        z_values = numpy.add(numpy.complex(initial_real_number, initial_imaginary_number),
                             c_values)
    ...
    def reinitialize(self):
        self.initialize(self._width, self._height, self._min_real_number, self._max_real_number,
                        ...
                        self._initial_real_number, self._initial_imaginary_number, self._power,
    ...
    def iterate(self):
        ...
        reducable_arrays = [self._x_indexes, self._y_indexes, z_values_new, self._c_values]
        self._x_indexes, self._y_indexes, self._z_values, self._c_values = (
            remove_indexes(reducable_arrays, remaining_indexes))
